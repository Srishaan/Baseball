...
pie_chart
```
## Best Draft Class Through all the MLB Years
...
We can observe that outfielders (CF or LF), first basemen (1B), and third basemen (3B) have frequently been the most successful positions. This can be explained by the high level fielding positions of outfield and third base, as well as the game-changing power hitting of first basemen.
